...
export const POLICY_SCHEMA = {
  ...
  properties: {
    ...
    jev: {
        ...
        shadow: {
          ...
          properties: {
            enabled: {
              type: "boolean",
              description:
                "Shadow-mode classify hook in route (slice 3): when true, route classifies --task text with Jev and records the descriptor beside the supplied one. Routing never changes; LLM_ROUTER_JEV_SHADOW=off always disables it.",
            },
          },
          description:
      ...
      description:
        "Optional Jev settings. Absent means every Jev hook is disabled.",
    },
